package com.jerry.simpleui.widget;
 ...
 * @author
 */
public class UIClearEditText extends AppCompatEditText implements View.OnTouchListener, TextWatcher, View.OnFocusChangeListener {
